...
parser$add_argument("-r", "--rm_dir", default=FALSE,
...
#file.rename(paste(args$out_dir,".zip", sep=""), paste("./static/download/",args$out_dir,".zip", sep=""))
file.rename(args$out_dir, paste("./static/dynamic/",args$out_dir, sep=""))
# We are also creating this zip file from the python app and including a few additional files
zip_file <- paste(args$out_dir,".zip", sep="")
